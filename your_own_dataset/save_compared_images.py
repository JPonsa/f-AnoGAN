...
def main(opt):
    ...
    test_dataloader = DataLoader(dataset, batch_size=opt.n_grid_lines, shuffle=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "test_root", type=str, help="root name of your dataset in test mode"
    )
    parser.add_argument(
        "--n_grid_lines",
        type=int,
    ...
    parser.add_argument(
        "--force_download", "-f", action="store_true", help="flag of force download"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--n_iters", type=int, default=None, help="value of stopping iterations"
    )
